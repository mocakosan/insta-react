        ...
        ? board_query.data.data.map((e, index) => (
            <div className="board" key={index}>
              ...
              <div className="b_head">
                ...
                <button className="b_update" onClick={() => onUpdate(e)}>
                  수정
                </button>

                <button
                  className="b_delete"
                  onClick={() => onDelete(e.board_id)}
                >
                  삭제
                </button>
              </div>
              ...
              <div className="b_container">
                {/* analytic */}
                <div className="b_an">
                  <button onClick={() => onhart(e.board_id)}>
                    {e.likes
                      .map((item) => item.user_email)
                      .includes(jwtUtils.getUserEmail(tokenUse)) ? (
                      <img src={heart} />
                    ) : (
                      <img src={heart1} />
                    )}
